...
SECRET_KEY = '#oa=qdz%=-=l6qk94c(w!#7a%o1o$s5w@!p)@^9=ltr+bmbo6c'
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = 'chenjb04@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'w2580473897'
# 收件人看到的发件人
...
FDFS_BASE_URL = 'http://192.168.59.130:8888/'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.59.130:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
